...
.data
# espacio destinado al frame buffer 32*32*4
pantalla:	.space 4096
...
loop:
		...
		beq $t0,$zero,loop	# si no se toco nada volver a leer
...
################# imprimir por consola cuantas notas memorizó ($t9)
		...
		li $v0,10
		syscall			# llamar a sistema para terminar
...
bordes:
		# columnas
		move $t1,$s1			# $t1 dir base del screen
		li $t0,0
